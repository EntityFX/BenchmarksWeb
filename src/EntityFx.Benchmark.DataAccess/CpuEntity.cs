...
namespace EntityFx.BenchmarkDb.DataAccess
{
    internal class CpuEntity
    {
        ...
        public uint? CacheL4SizeKBytes { get; set; }

        public CacheAssociativity? CacheL4CacheAssociativity { get; set; }

        public uint? CacheL4LineSizeInBytes { get; set; }

        public bool? CacheL4IsShared { get; set; }

        public string CacheL4Details { get; set; }
